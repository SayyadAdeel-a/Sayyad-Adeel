...
export default function HeroSection() {
  return (
    <div className="relative w-full bg-black text-text-primary overflow-hidden font-sans min-h-screen flex items-center pt-24 pb-12 border-b border-border-visible">
      {/* Dot grid background */}
      <div className="absolute inset-0 dot-grid-subtle opacity-50 pointer-events-none" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center space-y-12">
            ...
            <div className="space-y-4">
              ...
              >
                Architect <br />
                <span className="text-text-secondary outline-text-white">With AI.</span>
              </motion.h1>
          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
            <motion.div 
              className="card-surface p-8 relative overflow-hidden scanline"
            ...
            >
              ...
              <div className="flex justify-between items-start mb-12">
                <div className="flex items-center gap-4">
                  <div className="p-3 bg-black border border-border-visible">
              ...
              <div className="mt-12 flex flex-wrap gap-2">
                <div className="inline-flex items-center gap-2 border border-border-visible bg-black px-3 py-1 label-text">
            ...
            <motion.div 
              className="card-surface p-6 overflow-hidden relative group"
              initial={{ opacity: 0, x: 20 }}
              animate={{ opacity: 1, x: 0 }}
